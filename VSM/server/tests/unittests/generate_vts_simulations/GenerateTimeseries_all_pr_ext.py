import os
from GenerateTimeseries import CleanStatus,GenerateTimeseries, TimeseriesNames_vs_LoadcaseNames, LoadcaseConfiguration
...
class Generate_clean_all_pr_ext(GenerateTimeseries):
    ...
    def generate(self, base_path:str, timeseries_names_vs_loadcase: TimeseriesNames_vs_LoadcaseNames) -> dict[str, str]:
        # generate the test files and evaluate which files to keep and clean

        all_entries = self.generate_files(base_path, timeseries_names_vs_loadcase)
