...
Sets the application to integration test mode and executes integration test suite.
"""
...
def main():
    ...
    # Set test mode to integration test
    AppConfig.set_test_mode(AppConfig.Mode.INTEGRATION_TEST)
